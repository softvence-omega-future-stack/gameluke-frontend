            ...
            <div className="relative z-10 w-full max-w-5xl flex flex-col items-center gap-6">
                ...
                <div className="text-center mb-2">
                    ...
                    <p className="text-gray-400 text-xs font-semibold">
                        Your arena is ready - proceed to your room!
                    </p>
                </div>
                ...
                <div className="w-full bg-[#1A1A23]/60 border border-[#00E676]/40 rounded-2xl p-4 flex items-center gap-4 backdrop-blur-sm">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 text-[10px] font-medium leading-tight">
                            The admin has activated your room - head to your location now!
                        </p>
                    </div>
                </div>
                ...
                <div className="w-full bg-[#111116]/80 border border-[#FFFF00]/30 rounded-[20px] p-5 shadow-xl backdrop-blur-sm">
                    ...
                    <div className="bg-[#1A1A23] border border-[#FFFF00]/40 rounded-xl p-4 flex flex-col items-center">
                        ...
                        <h2 className="text-white text-2xl font-black uppercase mb-1 tracking-tight">Room 1</h2>
                        <p className="text-gray-500 text-[9px] font-medium">Game: Laser Tag Arena • Duration: 12 minutes</p>
                    </div>
                </div>
                ...
                <div className="w-full bg-[#111116]/80 border border-[#FFFF00]/30 rounded-[20px] p-5 shadow-xl backdrop-blur-sm">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p className="text-[#00E676] text-[10px] font-bold mt-1">Find your room location</p>
                        </div>
                    </div>
