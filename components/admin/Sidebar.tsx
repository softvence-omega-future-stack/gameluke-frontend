      ...
      >
        <div className="p-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] sm:text-xs text-zinc-500 mt-1 font-bold uppercase tracking-wider">
                GameArena Control
              </p>
            </div>
          </div>
        ...
        <div className="p-4 mt-auto">
          <button
            ...
            className="flex items-center gap-2 w-full py-2.5 px-4 text-sm font-medium text-white bg-zinc-800/50 border border-red-900/30 rounded-lg hover:bg-zinc-800 transition-colors cursor-pointer"
          >
